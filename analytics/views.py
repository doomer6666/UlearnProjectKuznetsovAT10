...
from .models import Vacancy, SalaryByYear, VacanciesCountByYear, SalaryByCity, VacanciesCountByCity, Skill
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for detail_data in details:
            job = {
                ...
                'salary': detail_data['salary']['from'] if detail_data.get('salary') else 'Не указано',
